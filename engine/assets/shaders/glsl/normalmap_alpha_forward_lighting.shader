...
void main()
{
    ...
    // This saves performance by not running lighting calculations for fully transparent fragments.
    // And preventing the depth buffer from being updated with transparent fragments.
    if (albedo.a < 0.001) {
        discard;
    }
    ...
    vec3 finalColor = (ambientBase + lightingAccumulator) * albedo.rgb;
